...
int caterva_update_array(caterva_array *carr, caterva_dims shape) {
...
int caterva_get_slice(caterva_array *src, caterva_array *dest, caterva_dims start, caterva_dims stop){
