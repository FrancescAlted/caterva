...
void test_get_slice(caterva_ctx_t *ctx, uint8_t ndim, uint64_t *shape_, uint64_t *pshape_, uint64_t *start_, uint64_t *stop_, uint64_t *pshape_dest_, double *result) {
