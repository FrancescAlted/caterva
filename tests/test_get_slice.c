...
void test_get_slice(caterva_ctx_t *ctx, int8_t ndim, int64_t *shape_, int64_t *pshape_,
    ...
    double *buf_src = (double *) malloc((size_t)buf_size * src->sc->typesize);
...
LWTEST_FIXTURE(get_slice, ndim_4) {
    ...
    int64_t pshape_[] = {3, 5, 2, 7};
    int64_t start_[] = {5, 3, 9, 2};
    int64_t stop_[] = {9, 6, 10, 7};
    int64_t pshape_dest_[] = {3, 2, 1, 3};
...
LWTEST_FIXTURE(get_slice, ndim_6) {
    ...
    int64_t pshape_[] = {4, 5, 3, 8, 3, 3};
    int64_t start_[] = {0, 4, 2, 4, 5, 1};
    int64_t stop_[] = {1, 7, 4, 6, 8, 3};
    int64_t pshape_dest_[] = {1, 2, 2, 2, 2, 2};
...
LWTEST_FIXTURE(get_slice, ndim_8) {
    ...
    int64_t pshape_[] = {2, 3, 4, 2, 3, 2, 4, 10};
    int64_t start_[] = {3, 5, 2, 4, 5, 1, 6, 0};
    int64_t stop_[] = {6, 6, 4, 6, 7, 3, 7, 3};
    int64_t pshape_dest_[] = {2, 1, 1, 3, 2, 2, 1, 2};
